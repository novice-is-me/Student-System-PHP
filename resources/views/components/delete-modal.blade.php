<div
    x-data="{ deleteModal: false, targetId: null }"
    x-show="deleteModal"
    x-on:open-delete-modal.window="deleteModal = true; targetId = $event.detail.id"
    x-on:close-delete-modal.window="deleteModal = false; targetId = null"
    ...
    <div class="bg-white p-6 rounded-lg">
        ...
        <div class="mt-4 flex justify-center gap-4">
            ...
            <button class="bg-red-500 text-black px-4 py-2 rounded hover:bg-red-700"
                    @click="$wire.delete(targetId)">Delete</button>
